    ...
    return (
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid  md:grid-cols-12">
          {/* Form Card */}
          <div className="md:col-span-7 rounded-md bg-white p-[30px] shadow-[0_6px_18px_rgba(0,0,0,0.06)]">
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex items-center gap-3 rounded-full bg-[#005d98] hover:bg-[#bace3d] px-4 py-3 text-white transition hover:opacity-90"
                >
                  SEND MESSAGE
                  <span className="grid h-8 w-8 place-items-center rounded-full bg-white">
                    <FaPaperPlane className="h-4 w-4 rotate-5 color:[#005d98] hover:color-[#130947] z-10" />
                  </span>
                </button>
              </div>
            </form>
          ...
          {/* Map Card */}
          <div className="md:col-span-5 rounded-md bg-white p-2 shadow-[0_6px_18px_rgba(0,0,0,0.06)]">
            <div className="h-full min-h-[420px] overflow-hidden rounded-md">
              <iframe
            ...
            <section className="mx-auto max-w-6xl px-4 pb-10">
                <div className="grid  md:grid-cols-2">
                    {branches.map((b) => (
                        <div
                            key={b.title}
                            className=" border border-[#b0cb1f] bg-white p-5 shadow-[0_4px_14px_rgba(0,0,0,0.05)]"
                        >
                            <h3 className="text-lg font-semibold tracking-wide text-[#0e5aa7]">
                                {b.title}
                            </h3>
                            <p className="mt-2 text-[15px] leading-6 text-[#4a5a6b]">{b.address}</p>

                            <div className="mt-3 space-y-2 text-[15px] text-[#4a5a6b]">
                                <div className="flex items-center gap-2">
                                    <FaPhoneAlt className="h-4 w-4 text-[#0e5aa7]" />
                                    <span>{b.phone}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <FaRegEnvelope className="h-4 w-4 text-[#0e5aa7]" />
                                    <span>{b.email}</span>
                                </div>
                            </div>
                        </div>
