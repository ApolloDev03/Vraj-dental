...
async function getSeoData() {
  try {
    ...
    console.error("Gallery SEO Error:", error);
    return null;
  }
}
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      meta?.metaTitle || "Gallery | Vraj Dental Clinic",
    ...
    openGraph: {
      ...
      url: "https://vrajdentalclinic.com/gallery",
    ...
    alternates: {
      canonical:
        "https://vrajdentalclinic.com/gallery",
    },
